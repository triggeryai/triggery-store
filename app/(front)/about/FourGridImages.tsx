      ...
      <div className="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto lg:py-6 md:px-6">
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full px-4 mb-10 xl:w-1/2 lg:mb-8 text-center lg:text-left">
            <span className="text-sm font-semibold text-blue-500 dark:text-blue-400 uppercase">Why choose us</span>
            <h2 className="mt-2 mb-4 text-3xl font-bold text-gray-700 dark:text-gray-300">
              We are providing better products
            </h2>
            <p className="mb-4 text-lg leading-7 text-gray-500 dark:text-gray-400">
              Discover a wide range of top-quality cleaning products, toilet paper, and wipes from leading brands at Domestico.
            </p>
            <ul className="mb-10 text-left">
              <li className="flex items-start mb-2">
                <span className="bg-blue-500 rounded-full p-2 text-white mr-2">✓</span> High-quality products
              </li>
              <li className="flex items-start mb-2">
                <span className="bg-blue-500 rounded-full p-2 text-white mr-2">✓</span> Affordable prices
              </li>
              <li className="flex items-start mb-2">
                <span className="bg-blue-500 rounded-full p-2 text-white mr-2">✓</span> Fast delivery
              </li>
            </ul>
            <a href="https://www.domestico.pl/" className="px-4 py-2 text-white bg-blue-500 rounded-md dark:bg-blue-400 dark:hover:bg-blue-500 hover:bg-blue-600">
              Learn more
            </a>
          </div>
        </div>
