          ...
          <li className="relative" 
            ...
            <Link href="/cart" passHref>
              <div className="btn btn-ghost rounded-btn flex items-center justify-between">
                {/* Ikona koszyka */}
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="darkslategray" aria-hidden="true" className="h-6 w-6 transition-all ease-in-out hover:scale-110 ml-2">
